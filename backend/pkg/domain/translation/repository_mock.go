...
func (_m *MockRepository) Get() []Translation {
	ret := _m.Called()

	var r0 []Translation
	if rf, ok := ret.Get(0).(func() []Translation); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_m *MockRepository) GetById(id string) *Translation {
	ret := _m.Called(id)

	var r0 *Translation
	if rf, ok := ret.Get(0).(func(string) *Translation); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*Translation)
...
func (_m *MockRepository) Save(_a0 Translation) error {
	ret := _m.Called(_a0)
